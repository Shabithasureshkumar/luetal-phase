...
export const RightSidebar: React.FC<RightSidebarProps> = ({
  ...
  return (
    <aside className="w-full lg:w-[329px] bg-white border-t-[1.2px] lg:border-t-0 lg:border-l-[1.2px] border-[#F3F4F6] p-4 sm:p-[19.2px] space-y-5 sm:space-y-6 shrink-0 mt-4 lg:mt-0">
      {/* 1. Profile Card */}

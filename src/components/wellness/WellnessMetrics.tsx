  ...
  return (
    <div className="w-full bg-white rounded-[19.2px] p-3.5 sm:p-[19.2px] shadow-[0px_1.2px_2.4px_rgba(0,0,0,0.05)] border-[1.2px] border-[#F3F4F6]">
      ...
      <div className="flex items-center justify-between pb-3.5">
        <div>
          <h2 className="text-[clamp(14px,1.5vw,16.8px)] font-bold text-[#1F2937] leading-snug sm:leading-[25.2px]">
            Wellness Metrics
          </h2>
          <p className="text-[clamp(11px,1.2vw,13.2px)] font-normal text-[#9CA3AF] leading-snug sm:leading-[19.8px]">
            {dateInfo}
          </p>
        </div>
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-[9.6px] border-[1.2px] border-[#E9D5FF] hover:bg-pink-50/50 transition-colors shrink-0 active:scale-95"
        >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 sm:gap-2.5">
        {cards.map((card, idx) => (
          <div
            key={idx}
            className="min-h-[130px] sm:min-h-[151px] bg-white rounded-[14.4px] p-3 sm:p-[14.4px] border-[1.2px] border-[#F3F4F6] shadow-[0px_1.2px_2.4px_rgba(0,0,0,0.05)] flex flex-col justify-between"
          >
            <div
            ...
            <div>
              <span className="text-[clamp(11px,1.2vw,13.2px)] font-normal text-[#9CA3AF] leading-tight sm:leading-[19.8px] block">
                {card.label}
              </span>
              <span className="text-[clamp(13px,1.4vw,15.6px)] font-bold text-[#1F2937] leading-tight sm:leading-[23.4px] block truncate mt-0.5">
                {card.value}
              </span>
            </div>
          </div>

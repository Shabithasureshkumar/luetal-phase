    ...
    <div className="w-full bg-white rounded-[19.2px] p-3.5 sm:p-[19.2px] shadow-[0px_1.2px_2.4px_rgba(0,0,0,0.05)] border-[1.2px] border-[#F3F4F6]">
      ...
      <div className="flex items-center justify-between pb-2 sm:pb-3">
        <div className="flex items-center gap-2 sm:gap-2.5">
          ...
          <h2 className="text-sm sm:text-[16.8px] font-bold text-[#1F2937] leading-[25.2px]">
            Calender
          </h2>
        </div>
        ...
        <div className="flex items-center gap-1 sm:gap-2.5">
          <button
            onClick={onPrevDay}
            className="w-7 h-7 sm:w-8 sm:h-8 rounded-[9.6px] hover:bg-gray-100 flex items-center justify-center text-gray-400 hover:text-gray-600 transition-colors"
            title="Previous Day"
          >
          ...
          <button
            onClick={onToday}
            className="px-3 sm:px-4 py-1 sm:py-1.5 rounded-full bg-[#FAF5FF] hover:bg-[#F3E8FF] transition-colors"
          >
      ...
      {/* Date Strip */}
      <div className="flex items-center justify-between gap-1 pt-2 sm:pt-4 pb-2 overflow-x-auto no-scrollbar">
        <button
          onClick={onPrevDay}
        ...
        <div className="flex-1 grid grid-cols-7 gap-1 sm:gap-2 min-w-[280px]">
          {days.map((item) => {
            ...
            return (
              <button
                ...
                className={`relative flex flex-col items-center justify-center py-2 sm:py-2.5 px-1 sm:px-2 rounded-[12px] sm:rounded-[14.4px] transition-all duration-200 min-h-[85px] sm:min-h-[105px] ${
                  isSelected
              ...
              >
                <span
                  className={`text-[11px] sm:text-[13.2px] font-medium leading-tight ${
                ...
                <span
                  className={`text-sm sm:text-[18px] font-bold leading-tight my-0.5 sm:my-1 ${
                ...
                <span
                  className={`text-[10px] sm:text-[12px] font-normal leading-tight ${
                ...
                <div className="mt-1 h-4 sm:h-5 flex items-center justify-center">
                  {item.dayNumber === 18 && (
                    <Droplet className="w-3 h-3 sm:w-4 sm:h-4 text-orange-400 stroke-[1.8]" />
                  )}
                  {item.dayNumber === 19 && (
                    <Droplet className="w-3 h-3 sm:w-4 sm:h-4 text-orange-400 stroke-[1.8]" />
                  )}
                  {item.dayNumber === 20 && (
                    <div className="w-3 h-3 sm:w-[17px] sm:h-[17px] rounded-full border-2 sm:border-[2.4px] border-[#93C5FD] bg-transparent" />
                  )}
                  {item.dayNumber >= 22 && (
                    <div className="w-3 h-3 sm:w-[17px] sm:h-[17px] rounded-full bg-[#E5E7EB]" />
                  )}
                </div>
              </button>
            );
      ...
      {/* Phase Legend */}
      <div className="flex flex-wrap items-center justify-start gap-2.5 sm:gap-5 pt-3 sm:pt-3.5 mt-1 text-[11px] sm:text-[12px] text-[#6B7280]">
